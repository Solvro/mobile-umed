...
class AppTheme implements AppThemeData {
  ...
  static const _textTheme = TextTheme(
    headlineLarge: TextStyle(
        fontSize: 20, fontWeight: FontWeight.w500, color: ColorConsts.onyx),
    headlineMedium: TextStyle(
        fontSize: 23,
        fontWeight: FontWeight.w400,
        color: ColorConsts.lightGreen),
    headlineSmall: TextStyle(
        fontSize: 17, fontWeight: FontWeight.w500, color: ColorConsts.onyx),
    titleMedium: TextStyle(
        fontSize: 15, fontWeight: FontWeight.w500, color: ColorConsts.onyx),
    ...
    displayLarge: TextStyle(
        fontSize: 24, fontWeight: FontWeight.w600, color: ColorConsts.dimGray),
  );
