      ...
      child: Scaffold(
        body: Stack(
          children: [
            ...
            SheetHidingHitTest(currentSheetState: _currentSheetState),
            RouteProgressBar(checkpoints: route.checkpoints),
            switch (allRoutesAsync) {
              AsyncData() => RouteBottomSheet(route: route),
...
class SheetHidingHitTest extends ConsumerWidget {
  const SheetHidingHitTest({required this.currentSheetState});
