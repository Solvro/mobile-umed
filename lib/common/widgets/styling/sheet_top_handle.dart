...
class SheetTopHandle extends SliverPersistentHeaderDelegate {
      ...
      child: Column(
        ...
        children: [
          const Icon(Icons.drag_handle,
              size: BottomSheetHeaderConfig.handleIconSize),
          if (controls != null)
            Padding(
                padding:
  ...
  @override
  double get minExtent => controls != null
      ? BottomSheetHeaderConfig.headerWithControls
      : BottomSheetHeaderConfig.headerWithoutControls;
  @override
  double get maxExtent => controls != null
      ? BottomSheetHeaderConfig.headerWithControls
      : BottomSheetHeaderConfig.headerWithoutControls;

  @override
  bool shouldRebuild(covariant SheetTopHandle oldDelegate) =>
...
BoxDecoration getSheetTopDecoration(Color color) => BoxDecoration(
      ...
      borderRadius: const BorderRadius.vertical(
          top: Radius.circular(BottomSheetHeaderConfig.roundedTopRadius)),
    );
